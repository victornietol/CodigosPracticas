...
class AlgoritmoGenetico:
    ...
    def algoritmoGen(self,nInd,tam,nMaxGen,indAnt=None):
        ...
        return mejorCodigo, poblacion[mejor]   # Regresa el código en representacion decimal (mejorCodigo) y binaria (poblacion[mejor])
