...
class Interfaz():
    ...
    def construir_pestania1(self, notebook):
        ...
        # Caja de texto
        caja_texto = scrolledtext.ScrolledText(subFrame_superior, wrap='word', height=12, relief='solid')
        ...
        caja_texto_cifrado = scrolledtext.ScrolledText(subFrame_central, wrap='word', height=12, relief='solid')
